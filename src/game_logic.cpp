...
GameLogic::GameLogic(QObject *parent)
    ...
    // Minimal init: only what's needed for the Splash screen
...
/** 
 * @brief Heavy I/O moved here to avoid startup lag.
 * Called by SplashState while the animation is playing.
 */
