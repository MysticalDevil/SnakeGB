...
Item {
    ...
    property var foodPos: ({
                               x: 0,
                               y: 0
                           })
    property var powerUpPos: ({
                                  x: -1,
                                  y: -1
                              })
    ...
    Repeater {
        ...
        delegate: Rectangle {
            ...
            color: gameWorld.activeBuff === PowerUpId.Gold
            ...
            border.color: index === 0
                          ? gameWorld.gameBorder
                          : Qt.rgba(gameWorld.gameBorder.r, gameWorld.gameBorder.g, gameWorld.gameBorder.b, 0.55)
            border.width: 1
            ...
            Rectangle {
                ...
                color: "transparent"
                border.color: index === 0
                              ? Qt.rgba(gameWorld.gamePanel.r, gameWorld.gamePanel.g, gameWorld.gamePanel.b, 0.34)
                              : Qt.rgba(gameWorld.gameInk.r, gameWorld.gameInk.g, gameWorld.gameInk.b, 0.14)
                border.width: 1
            }
    ...
    Repeater {
        ...
        delegate: Rectangle {
            ...
            width: gameWorld.cellW
            height: gameWorld.cellH
            color: gameWorld.activeBuff === PowerUpId.Freeze
                   ? Qt.rgba(gameWorld.gameObstacleFill.r, gameWorld.gameObstacleFill.g, gameWorld.gameObstacleFill.b, 0.55)
                   : ((gameWorld.currentLevelName === "Dynamic Pulse" || gameWorld.currentLevelName === "Crossfire"
                       || gameWorld.currentLevelName === "Shifting Box")
                      ? ((Math.floor(gameWorld.elapsed * 8) % 2 === 0) ? gameWorld.gameObstaclePulse
            ...
            Rectangle {
                ...
                anchors.margins: 2
                color: "transparent"
                border.color: Qt.rgba(gameWorld.gamePanel.r, gameWorld.gamePanel.g, gameWorld.gamePanel.b, 0.24)
                border.width: 1
            }
            ...
            Rectangle {
                ...
                x: parent.width * 0.22
                y: 2
                color: Qt.rgba(gameWorld.gameBorder.r, gameWorld.gameBorder.g, gameWorld.gameBorder.b, 0.26)
            }
            ...
            Rectangle {
                ...
                x: parent.width * 0.62
                y: 2
                color: Qt.rgba(gameWorld.gamePanel.r, gameWorld.gamePanel.g, gameWorld.gamePanel.b, 0.18)
            }
        }
    }
    ...
    Item {
        ...
        Icons.FoodGlyph {
            anchors.fill: parent
            strokeColor: gameWorld.gameBorder
            coreColor: menuColor ? menuColor("actionCard") : gameWorld.gameInk
            highlightColor: gameWorld.gameBg
            stemColor: gameWorld.gameBorder
            sparkColor: gameWorld.gameSubInk
        }
    }
    ...
    Item {
        ...
        Icons.PowerIcon {
            ...
            radius: 3
            contentMargin: 2
            fillColor: Qt.rgba(gameWorld.gamePanel.r, gameWorld.gamePanel.g, gameWorld.gamePanel.b, 0.90)
            borderColor: Qt.rgba(powerColor(gameWorld.powerUpType).r, powerColor(gameWorld.powerUpType).g,
                                  powerColor(gameWorld.powerUpType).b, 0.30)
            borderWidth: 1
            powerType: gameWorld.powerUpType
            glyphColor: powerColor(gameWorld.powerUpType)
        }
    ...
    Rectangle {
        visible: gameWorld.activeBuff === PowerUpId.Scout && gameWorld.scoutHintCell.x !== -1
        x: gameWorld.scoutHintCell.x * gameWorld.cellW
        y: gameWorld.scoutHintCell.y * gameWorld.cellH
        width: gameWorld.cellW
        height: gameWorld.cellH
        radius: 4
        color: "transparent"
        border.color: powerColor(PowerUpId.Scout)
        border.width: 2
        opacity: (Math.floor(gameWorld.elapsed * 6) % 2 === 0) ? 0.85 : 0.35
        z: gameWorld.layerPowerUp + 2
    }
