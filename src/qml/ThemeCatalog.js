...
const _catalog = {
  menu : {
    "Original DMG" : {
      cardPrimary : "#d7e7b2",
      cardSecondary : "#c7d99d",
      actionCard : "#4e7a39",
      hintCard : "#92b65a",
      borderPrimary : "#39582a",
      borderSecondary : "#577d3e",
      titleInk : "#213319",
      secondaryInk : "#253a1b",
      actionInk : "#f2f8e4",
      hintInk : "#1d2d15"
    ...
    "Pocket B&W" : {
      cardPrimary : "#e3e5dd",
      cardSecondary : "#d4d8cc",
      actionCard : "#5a6250",
      hintCard : "#b8bead",
      borderPrimary : "#4f5648",
      borderSecondary : "#646b5b",
      titleInk : "#1d211b",
      secondaryInk : "#242822",
      actionInk : "#edf1e8",
      hintInk : "#22261f"
    ...
    "Sunset Glow" : {
      cardPrimary : "#f5cf5d",
      cardSecondary : "#e9bf45",
      actionCard : "#825118",
      hintCard : "#c89030",
      borderPrimary : "#6d4412",
      borderSecondary : "#89591b",
      titleInk : "#2a1a06",
      secondaryInk : "#342109",
      actionInk : "#fff4c5",
      hintInk : "#2d1d0a"
    ...
    "Pixel Heat" : {
      cardPrimary : "#d44f4f",
      cardSecondary : "#c53f3f",
      actionCard : "#4e1111",
      hintCard : "#7a2626",
      borderPrimary : "#6c2424",
      borderSecondary : "#8f3939",
      titleInk : "#2b0a0a",
      secondaryInk : "#320d0d",
      actionInk : "#ffe7df",
      hintInk : "#f9e3dc"
    ...
    "Neon Ice" : {
      cardPrimary : "#78d9df",
      cardSecondary : "#67c1c8",
      actionCard : "#1e5f68",
      hintCard : "#327f87",
      borderPrimary : "#184c53",
      borderSecondary : "#2c747b",
      titleInk : "#08272d",
      secondaryInk : "#0d3138",
      actionInk : "#dcfbff",
      hintInk : "#e6fcff"
  ...
  pages : {catalog : {}, achievements : {}},
  shells : {
    "Matte Silver" : {
      shellBase : "#c0c0c0",
      shellBorder : "#7e8288",
      shellHighlight : "#f2f4f6",
      shellShade : "#adb1b8",
      brandInk : "#50545d",
      subtitleInk : "#747a84",
      bezelBase : "#3f4652",
    ...
    "Cloud White" : {
      ...
      bezelEdge : "#21262d",
      bezelInner : "#11151c",
      bezelInnerBorder : "#5f6671",
      labelInk : "#8f97a5",
      grillInk : "#5a5f69",
      wheelTrackA : "#314151",
      wheelTrackB : "#263543",
      wheelBody : "#6d7990",
      wheelBodyDark : "#515d72",
      wheelBodyLight : "#8592ab"
    },
    "Lavender" : {
      shellBase : "#9370db",
      shellBorder : "#5d4790",
      shellHighlight : "#b69ae8",
      shellShade : "#7d5fc2",
      brandInk : "#2c1f45",
      subtitleInk : "#453463",
      bezelBase : "#3e4350",
      bezelEdge : "#1f242b",
      bezelInner : "#111419",
      bezelInnerBorder : "#5a6270",
      labelInk : "#8f95a2",
      grillInk : "#393d47",
      wheelTrackA : "#293848",
      wheelTrackB : "#243241",
      wheelBody : "#667286",
      wheelBodyDark : "#4b5668",
      wheelBodyLight : "#808ba0"
    },
    "Crimson" : {
      shellBase : "#ff0000",
      shellBorder : "#8a2020",
      shellHighlight : "#ff5a5a",
      shellShade : "#d72828",
      brandInk : "#3a0909",
      subtitleInk : "#5a1313",
      bezelBase : "#404651",
      bezelEdge : "#22272d",
      bezelInner : "#12161b",
      bezelInnerBorder : "#5e646f",
      labelInk : "#9196a1",
      grillInk : "#3f434a",
      wheelTrackA : "#2c3b49",
      wheelTrackB : "#263443",
      wheelBody : "#687488",
      wheelBodyDark : "#4d586a",
      wheelBodyLight : "#828ea5"
    },
    "Teal" : {
      shellBase : "#008080",
      shellBorder : "#0d5a5f",
      shellHighlight : "#22a2a2",
      shellShade : "#0b6e73",
      brandInk : "#093639",
      subtitleInk : "#155054",
      bezelBase : "#3c4350",
      bezelEdge : "#1f252d",
      bezelInner : "#10151b",
      bezelInnerBorder : "#59616f",
      labelInk : "#8f97a4",
      grillInk : "#29474d",
      wheelTrackA : "#253542",
      wheelTrackB : "#1f2d38",
      wheelBody : "#5e6b7f",
      wheelBodyDark : "#475466",
      wheelBodyLight : "#748199"
    },
    "Sunburst" : {
      shellBase : "#ffd700",
      shellBorder : "#9f7f16",
      shellHighlight : "#ffe870",
      shellShade : "#e3be1f",
      brandInk : "#4a3907",
      subtitleInk : "#6f5a0d",
      bezelBase : "#424850",
      bezelEdge : "#24272d",
      bezelInner : "#13161a",
      bezelInnerBorder : "#61666f",
      labelInk : "#9197a1",
      grillInk : "#5d4d13",
      wheelTrackA : "#36434f",
      wheelTrackB : "#2e3b47",
      wheelBody : "#738095",
      wheelBodyDark : "#566276",
      wheelBodyLight : "#8a97ae"
    },
    "Graphite" : {
      shellBase : "#2f4f4f",
      shellBorder : "#1d2f30",
      shellHighlight : "#4a6b6b",
      shellShade : "#284444",
      brandInk : "#101919",
      subtitleInk : "#1a2a2a",
      bezelBase : "#4a4f56",
      bezelEdge : "#292d33",
      bezelInner : "#14181c",
      bezelInnerBorder : "#676d75",
      labelInk : "#9aa0a8",
      grillInk : "#172324",
      wheelTrackA : "#3b4652",
      wheelTrackB : "#333e4a",
      wheelBody : "#7a8598",
      wheelBodyDark : "#5d6778",
      wheelBodyLight : "#939db2"
    }
  }
};
...
const menuColor = (paletteName, role, fallback) => {
  ...
  if (table && Object.prototype.hasOwnProperty.call(table, role))
    return table[role];
...
const pageColor = (paletteName, page, role, fallback) => {
  ...
  if (Object.prototype.hasOwnProperty.call(t, role))
    return t[role];
  return fallback;
};
...
const shellTheme = (shellName, shellColor) => {
  ...
  const shellPrimaryInk =
    _ensureContrast(theme.brandInk, theme.shellBase, 4.6, "#1b1724", "#f4f1fb");
  const shellSecondaryInk =
    _softenInk(shellPrimaryInk, theme.shellBase, 0.24, 3.4, shellPrimaryInk, "#ece8f5");
  const buttonLabelInk =
    _ensureContrast(shellPrimaryInk, theme.shellBase, 5.0, "#16131d", "#faf7ff");
  ...
  const logoSecondary =
    _softenInk(logoAccent, theme.shellBase, 0.42, 2.7, shellPrimaryInk, "#8377ba");
...
const powerAccent = (paletteName, type, fallback) => {
  if (type === 6)
    return menuColor(paletteName, "actionInk", fallback); // Gold
  if (type === 7)
    return menuColor(paletteName, "borderSecondary", fallback); // Laser
  if (type === 9)
    return menuColor(paletteName, "hintCard", fallback); // Freeze
  if (type === 4)
    return menuColor(paletteName, "secondaryInk", fallback); // Shield
  if (type === 5)
    return menuColor(paletteName, "borderPrimary", fallback); // Portal
  return menuColor(paletteName, "titleInk", fallback);        // Common
};

const rarityAccent = (paletteName, tier, fallback) => {
  if (tier === 4)
    return menuColor(paletteName, "hintCard", fallback);
  if (tier === 3)
    return menuColor(paletteName, "borderPrimary", fallback);
  if (tier === 2)
    return menuColor(paletteName, "secondaryInk", fallback);
