    ...
    Connections {
        ...
        function onBuffChanged() {
            if (gameLogic.activeBuff !== 0) {
                osdTimer.restart()
                var buffName = ""
                if (gameLogic.activeBuff === 1) buffName = "GHOST MODE"
                else if (gameLogic.activeBuff === 2) buffName = "SLOW DOWN"
                else if (gameLogic.activeBuff === 3) buffName = "MAGNET ON"
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            Column {
                                ...
                                Text { text: qsTr("SELECT to Cycle Levels"); font.family: gameFont; font.pixelSize: 10; color: p3; anchors.horizontalCenter: parent.horizontalCenter }
                                Text {
