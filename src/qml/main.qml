...
Window {
    ...
    // Palette shorthands
    readonly property color p0: gameLogic.palette[0] // Background
    readonly property color p1: gameLogic.palette[1] // Grid/Light segments
    readonly property color p2: gameLogic.palette[2] // Snake body
    readonly property color p3: gameLogic.palette[3] // Snake head/Food/Text
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                width: 240; height: 216; color: p0; clip: true
                ...
                Rectangle { // Menu
                    ...
                    Column {
                        ...
                        Text { 
                            text: "Press Start"
                            font.pixelSize: 14; color: p3; anchors.horizontalCenter: parent.horizontalCenter
