            ...
            Column {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        Column { 
                            anchors.centerIn: parent
                            Text { text: modelData.name; color: p3; font.family: gameFont; font.pixelSize: 9; font.bold: true; anchors.horizontalCenter: parent.horizontalCenter }
                            Text { text: modelData.desc; color: p3; font.family: gameFont; font.pixelSize: 6; anchors.horizontalCenter: parent.horizontalCenter } 
                        }
                    }
                }
            }
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        Row { 
                            ...
                            anchors.margins: 5
                            spacing: 10
                            Rectangle { width: 16; height: 16; rotation: 45; color: modelData.discovered ? p3 : p2; anchors.verticalCenter: parent.verticalCenter }
                            Column { 
                                Text { text: modelData.name; color: p3; font.pixelSize: 8; font.bold: true }
