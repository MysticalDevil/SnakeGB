...
void applyReplayInputsForTick(const QList<ReplayFrame> &inputFrames, const int currentTick,
...
void applyReplayChoiceForTick(const QList<ChoiceRecord> &choiceFrames, const int currentTick,
