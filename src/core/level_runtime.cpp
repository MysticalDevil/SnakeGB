    ...
    switch (normalized) {
        ...
        case 1:
            return {.name = QStringLiteral("The Cage"),
                    .script = QString(),
                    .walls = {QPoint(5, 5), QPoint(6, 5), QPoint(14, 5), QPoint(15, 5), QPoint(5, 12), QPoint(6, 12),
                              QPoint(14, 12), QPoint(15, 12)}};
        case 2:
            return {.name = QStringLiteral("Dynamic Pulse"),
                    .script = QStringLiteral("function onTick(tick) { var x1 = 5 + Math.floor(Math.abs(Math.sin(tick "
        ...
        case 3:
            return {.name = QStringLiteral("Tunnel Run"),
                    .script = QString(),
                    .walls = {QPoint(9, 4), QPoint(9, 5), QPoint(9, 6), QPoint(9, 7), QPoint(9, 10), QPoint(9, 11),
                              QPoint(9, 12), QPoint(9, 13), QPoint(10, 4), QPoint(10, 5), QPoint(10, 6), QPoint(10, 7),
                              QPoint(10, 10), QPoint(10, 11), QPoint(10, 12), QPoint(10, 13)}};
        case 4:
            return {.name = QStringLiteral("Crossfire"),
                    .script = QStringLiteral("function onTick(tick) { var t = Math.floor(tick * 0.5) % 8; var left = "
                                             "4 + t; var right = 15 - t; return "
                                             "[{x:left,y:8},{x:left,y:9},{x:right,y:8},{x:right,y:9},{x:9,y:4+t},{x:10,"
                                             "y:13-t}]; }"),
                    .walls = {QPoint(5, 8), QPoint(6, 8), QPoint(7, 8), QPoint(8, 8), QPoint(11, 8), QPoint(12, 8),
                              QPoint(13, 8), QPoint(14, 8), QPoint(5, 9), QPoint(6, 9), QPoint(7, 9), QPoint(8, 9),
                              QPoint(11, 9), QPoint(12, 9), QPoint(13, 9), QPoint(14, 9)}};
        case 5:
            return {.name = QStringLiteral("Shifting Box"),
                    .script = QStringLiteral("function onTick(tick) { var d = Math.floor((Math.sin(tick * 0.08) + 1.0) "
                    ...
                    .walls = {QPoint(4, 4), QPoint(5, 4), QPoint(6, 4), QPoint(13, 4), QPoint(14, 4), QPoint(15, 4),
                              QPoint(4, 13), QPoint(5, 13), QPoint(6, 13), QPoint(13, 13), QPoint(14, 13),
                              QPoint(15, 13), QPoint(4, 5), QPoint(4, 12), QPoint(15, 5), QPoint(15, 12)}};
        default:
            break;
    }
    return {.name = QStringLiteral("Classic"), .script = QString(), .walls = {}};
