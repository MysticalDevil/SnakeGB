...
private:
    ...
    void generateSquareWave(int frequencyHz, int durationMs, QByteArray &buffer, int amplitude = 32,
                            double duty = 0.25, float pan = 0.0f);
    ...
    const std::vector<NotePair> m_richMelody = {
        {440, 220, 300}, {494, 247, 300}, {523, 261, 300}, {587, 293, 300}, {659, 329, 600},
        {587, 293, 600}, {523, 261, 300}, {494, 247, 300}, {440, 220, 600}, {0, 0, 300},
        {330, 165, 300}, {392, 196, 300}, {440, 220, 600}, {392, 196, 300}, {330, 165, 300},
        {293, 146, 600}, {440, 220, 300}, {494, 247, 300}, {523, 261, 300}, {587, 293, 300},
        {659, 329, 600}, {784, 392, 600}, {880, 440, 600}, {784, 392, 300}, {659, 329, 300},
        {587, 293, 600}};
#endif
};
