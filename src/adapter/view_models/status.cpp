    ...
    : QObject(parent), m_engineAdapter(engineAdapter)
{
    ...
    connect(m_engineAdapter, &EngineAdapter::hasSaveChanged, this,
            &SessionStatusViewModel::hasSaveChanged);
    ...
    connect(m_engineAdapter, &EngineAdapter::levelChanged, this,
            &SessionStatusViewModel::levelChanged);
}
