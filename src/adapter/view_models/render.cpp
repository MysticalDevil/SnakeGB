...
SessionRenderViewModel::SessionRenderViewModel(EngineAdapter *engineAdapter, QObject *parent)
    : QObject(parent), m_engineAdapter(engineAdapter)
{
    ...
    connect(m_engineAdapter, &EngineAdapter::powerUpChanged, this,
            &SessionRenderViewModel::powerUpChanged);
    connect(m_engineAdapter, &EngineAdapter::scoreChanged, this, &SessionRenderViewModel::scoreChanged);
    connect(m_engineAdapter, &EngineAdapter::highScoreChanged, this,
            &SessionRenderViewModel::highScoreChanged);
    connect(m_engineAdapter, &EngineAdapter::stateChanged, this, &SessionRenderViewModel::stateChanged);
    connect(m_engineAdapter, &EngineAdapter::obstaclesChanged, this,
            &SessionRenderViewModel::obstaclesChanged);
    connect(m_engineAdapter, &EngineAdapter::ghostChanged, this, &SessionRenderViewModel::ghostChanged);
    connect(m_engineAdapter, &EngineAdapter::buffChanged, this, &SessionRenderViewModel::buffChanged);
    connect(m_engineAdapter, &EngineAdapter::reflectionOffsetChanged, this,
