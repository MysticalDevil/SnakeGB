    ...
    : QObject(parent), m_engineAdapter(engineAdapter)
{
    ...
    connect(m_engineAdapter, &EngineAdapter::choicesChanged, this, &SelectionViewModel::choicesChanged);
    connect(m_engineAdapter, &EngineAdapter::choicePendingChanged, this,
            &SelectionViewModel::choicePendingChanged);
    connect(m_engineAdapter, &EngineAdapter::choiceIndexChanged, this,
            &SelectionViewModel::choiceIndexChanged);
    connect(m_engineAdapter, &EngineAdapter::libraryIndexChanged, this,
            &SelectionViewModel::libraryIndexChanged);
    connect(m_engineAdapter, &EngineAdapter::medalIndexChanged, this,
            &SelectionViewModel::medalIndexChanged);
    connect(m_engineAdapter, &EngineAdapter::achievementsChanged, this,
