    ...
    : QObject(parent), m_engineAdapter(engineAdapter)
{
    ...
    connect(m_engineAdapter, &EngineAdapter::paletteChanged, this, &UiCommandController::paletteChanged);
    connect(m_engineAdapter, &EngineAdapter::shellColorChanged, this, &UiCommandController::shellChanged);
    connect(m_engineAdapter, &EngineAdapter::achievementEarned, this,
