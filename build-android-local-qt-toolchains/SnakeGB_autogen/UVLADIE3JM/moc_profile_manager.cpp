/****************************************************************************
** Meta object code from reading C++ file 'profile_manager.h'
**
...
#error "The header file 'profile_manager.h' doesn't include <QObject>."
...
void ProfileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->medalUnlocked((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProfileManager::*)(const QString & )>(_a, &ProfileManager::medalUnlocked, 0))
            return;
    }
}
...
// SIGNAL 0
void ProfileManager::medalUnlocked(const QString & _t1)
{
